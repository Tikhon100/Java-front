...
export default{
  ...
  methods:{
    getCountry() {
      ...
      axios.get(`http://localhost:8080/api/v1/country/${this.id}`)
      .then(res => {
    ...
    updateNameCountry(){
      ...
      axios.patch(`http://localhost:8080/api/v1/country/updateName/${this.update_name_country_id}?name=${this.new_name}`)  
      .then(res => {
        const country = res.data;
        // Формирование строки с языками
    ...
    deleteCountry(){
      ...
      this.delete_error = "";
      axios.delete(`http://localhost:8080/api/v1/country/delete/${this.delete_id}`)
      .then(res => {
    ...
    submitCountry() {
      axios.post('http://localhost:8080/api/v1/country/create', this.country)
        .then(response => {
